...
const uploadData_router_1 = __importDefault(require("./uploadData.router"));
...
router.use("/upload-data", uploadData_router_1.default);
router.use("/issues", issues_route_1.default);
