...
// Create a new unit
router.post("/", auth_controller_1.AuthController.allowedto([enums_1.UsersRoles.Admin]), (0, validationMiddleware_1.validateData)(UnitValidator_1.unitCategoryValidation), (0, express_async_handler_1.default)(unitCategory_controller_1.UnitCategoryController.createUnitCategory));
// Update an existing unit
router.put("/:id", auth_controller_1.AuthController.allowedto([enums_1.UsersRoles.Admin]), (0, validationMiddleware_1.validateData)(UnitValidator_1.unitCategoryValidation), (0, express_async_handler_1.default)(unitCategory_controller_1.UnitCategoryController.updateUnitCategory));
// Delete a unit
